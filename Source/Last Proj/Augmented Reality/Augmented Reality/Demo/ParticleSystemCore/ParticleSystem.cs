...
namespace ParticleSystemCore
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        {
            set { if (value != null) { settings = value; } }
            get { return settings; }
        }

        public bool IsEmptyPaticles()
        {
            if (firstActiveParticle == firstFreeParticle && firstRetiredParticle == firstActiveParticle)
            {
                return true;
            }
            return false;
